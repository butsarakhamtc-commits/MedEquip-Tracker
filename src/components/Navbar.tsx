          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {onOpenBackupModal && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-teal-600 hover:bg-teal-500 text-white border border-teal-500 rounded-xl text-xs sm:text-sm font-semibold transition-all shadow-sm active:scale-95"
                title="สำรอง & ย้ายข้อมูล (Export/Import)"
              >
                <Database className="w-4 h-4 text-white" />
                <span className="hidden md:inline">สำรอง/ย้ายข้อมูล</span>
              </button>
            )}
